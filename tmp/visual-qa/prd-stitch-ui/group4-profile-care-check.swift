...
assertContains(profileReadiness, "DJEnableProfileHiddenBranches", "profile hidden branches need explicit UIQA launch argument")
assertContains(profile, "ProfileFamilyPersonaReleaseReadiness.hiddenBranchesLaunchArgument", "profile should consume the hidden branch argument from readiness contract")
...
assertContains(profile, "ProfileFamilyPersonaReleaseReadiness.isFamilyManagementRowVisible", "family management row should use the readiness visibility contract")
