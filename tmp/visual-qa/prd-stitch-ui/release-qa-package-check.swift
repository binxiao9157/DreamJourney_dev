...
let requiredScripts = [
    ...
    "tmp/visual-qa/prd-stitch-ui/archive-local-file-path-recovery-check.swift",
    ...
    "tmp/visual-qa/prd-stitch-ui/true-device-acceptance-evidence-package-check.swift",
    ...
    "tmp/visual-qa/prd-stitch-ui/archive-media-provider-switch-contract-check.swift",
    "tmp/visual-qa/prd-stitch-ui/archive-hidden-media-timeletter-shell-check.swift",
    "tmp/visual-qa/prd-stitch-ui/time-letter-delivery-policy-shell-check.swift",
    ...
    "tmp/visual-qa/prd-stitch-ui/archive-video-hidden-readiness-check.swift",
    ...
    "tmp/visual-qa/prd-stitch-ui/archive-image-analysis-runtime-contract-check.swift",
    "tmp/visual-qa/prd-stitch-ui/archive-image-analysis-runtime-ui-check.swift",
    ...
    "tmp/visual-qa/prd-stitch-ui/backend-digital-human-session-smoke-check.swift",
    "tmp/visual-qa/prd-stitch-ui/backend-digital-human-session-smoke.py",
    "tmp/visual-qa/prd-stitch-ui/run-backend-digital-human-session-smoke.sh",
    "tmp/visual-qa/prd-stitch-ui/voice-synthesis-viseme-contract-check.swift",
    "tmp/visual-qa/prd-stitch-ui/memoir-tts-cache-contract-check.swift",
    ...
    "tmp/visual-qa/prd-stitch-ui/voice-sdk-readiness-boundary-check.swift",
