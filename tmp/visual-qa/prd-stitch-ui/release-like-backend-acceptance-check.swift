...
for phrase in [
    ...
    "blocked for the newer delayed-reply dispatch-due contract",
    ...
    "token_hits=0",
    "delayed-reply dispatch-due remains blocked on deployed route parity",
    "APNs provider delivery, service-side scheduled dispatch, and true-device notification arrival remain external gates",
    "BACKEND_BASE_URL",
    "BACKEND_API_TOKEN",
    "真机验收：not accepted",
] {
