...
let backendSmoke = "tmp/visual-qa/prd-stitch-ui/backend-voice-synthesis-viseme-smoke.py"
let backendRunner = "tmp/visual-qa/prd-stitch-ui/run-backend-voice-synthesis-viseme-smoke.sh"
let comboRunner = "tmp/visual-qa/prd-stitch-ui/run-digital-human-tts-viseme-gate.sh"
