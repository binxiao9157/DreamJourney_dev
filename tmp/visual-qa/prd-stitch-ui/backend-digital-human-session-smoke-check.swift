...
let runner = "tmp/visual-qa/prd-stitch-ui/run-backend-digital-human-session-smoke.sh"
let pythonSmoke = "tmp/visual-qa/prd-stitch-ui/backend-digital-human-session-smoke.py"
