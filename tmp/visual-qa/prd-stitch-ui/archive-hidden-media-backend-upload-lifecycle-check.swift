...
let backendSmoke = read("tmp/visual-qa/prd-stitch-ui/backend-hidden-media-sync-smoke.py")
let backendSmokeRunner = read("tmp/visual-qa/prd-stitch-ui/run-backend-hidden-media-sync-smoke.sh")
