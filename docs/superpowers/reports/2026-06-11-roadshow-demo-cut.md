...
- `fm_daughter_chen_lan`：陈岚，女儿，最近更新“刚刚”，用于成员级看板裁剪验证。
- `fm_son_chen_hao`：陈浩，儿子，最近更新“路演数据”，用于亲友列表和分享对象验证。
- `fm_granddaughter_chen_yu`：陈予，孙女，最近更新“路演数据”，用于时空信箱和家庭叙事。
...
- 语音陪伴 3：用户说“下午一个人在家有点孤单，想听听陈予的声音。”。
- 关怀信号片段：用户说“这两天胸闷，胃口差，也吃不下多少。”，该轮只授权给 `fm_daughter_chen_lan`。
- 档案/信箱片段：用户分别提到“1984 年弄堂里全家吃年夜饭”和“写给陈予十八岁生日”。

### 时空信箱

- 收件人：爷爷。
- 标题：`写给爷爷的一封信`。
- 正文首行：`爷爷，我今天又想起 1975 年外滩那张合影。`
...
- 文本条目：`外滩合影的背景`，说明“1975 年 7 月，陈树安和陈静文在外滩拍过一张全家合影。”
- 性格条目：`陈树安的习惯`，说明“说话慢，喜欢先听完别人讲完再回答。”
- 口头禅条目：`慢慢来，饭要趁热吃`。
...
- 生成入口：知识库/同步页导出。
- 分享对象：先选“全体亲友”，再选“陈岚（女儿）”或其他成员验证裁剪。
...
2. 打开底部“信箱”，展示写给爷爷的信和回声。讲清楚回声来自已保存记忆，页面文案明确“不是逝者真实回复”。
