...
| Profile | Hidden `阳光 / 星辰 / 静默` mode management | Hidden family rows expose a QA context menu only; mode is persisted locally and drives care visibility, but no public lifecycle policy is exposed. |
