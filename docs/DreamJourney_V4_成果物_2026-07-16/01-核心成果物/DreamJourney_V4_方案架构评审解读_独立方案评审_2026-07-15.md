...
> **历史基线提示（2026-07-16）：** 本文件冻结 7 月 15 日产品回复和旧三级验证结论，不再是当前发布范围 Authority。受新规影响的全龄虚拟亲属、家庭代录、逝者 Voice/DH、导出能力和发布阶段，以 `DreamJourney_V4_方案架构评审解读_新规生效增量复审_2026-07-16.md`、V4.3 Product Spec 和 V1.3 决策登记册为准。本文件中的旧结论仅用于追踪“为什么发生变化”。
...
- [路线执行注册表](../02-追踪与执行/DreamJourney_V4_路线执行注册表_V1.0.json)
...
- [2026-07-15 产品决策同步与静态验收报告](../05-交付记录/DreamJourney_V4_2026-07-15_产品决策同步与静态验收报告.md)：记录本次变更、生成结果、检查结果和剩余外部门。
