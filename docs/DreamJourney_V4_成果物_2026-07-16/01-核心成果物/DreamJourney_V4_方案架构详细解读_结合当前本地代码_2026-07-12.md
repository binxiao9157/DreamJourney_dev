...
>
> **产品范围提示（2026-07-16）：** 本文的源码观察继续锁定 7 月 12 日，不重写历史工程证据；其中 Closed Pilot/Product MVP/Beta Extension、全龄人物、家庭声音和逝者高风险能力等产品口径已被 M0-M4 新规基线取代。当前范围以 7 月 16 日增量复审、V4.3 Product Spec 和 V1.3 决策登记册为准。

- 工程分析日期：2026-07-12；产品口径提示更新：2026-07-16
