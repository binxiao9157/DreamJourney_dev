...
| 2 | create-solution-ticket | P0 persona-scoped archive and echo context | `docs/plans/task_02_p0-persona-scoped-archive-and-echo-context.md` | `L20260618-000157-02` |
| 3 | create-solution-ticket | P0 real-device and backend acceptance readiness | `docs/plans/task_03_p0-real-device-and-backend-acceptance-readiness.md` | `L20260618-000157-03` |
