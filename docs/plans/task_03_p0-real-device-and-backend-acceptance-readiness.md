# P0 real-device and backend acceptance readiness

## Context

Harden microphone/photo/backend configuration, privacy, and QA instructions for true-device and non-local backend validation
