...
- [x] Add failing backend tests for exclusive allocation, capacity exhaustion, compatibility, and synthesis authorization.
- [x] Implement store-level slot allocation and lifecycle transitions.
- [x] Integrate logical/provider ID separation into training, refresh, quality acceptance, disable/delete, and synthesis.
- [x] Update iOS-generated logical profile IDs and static QA guards.
- [x] Refresh status/operations documentation.
- [x] Run backend tests, QA checks, `git diff --check`, and iOS build.
- [x] Complete Lodestar review and record remaining external risks.
...
- Ledger ID: `L20260710-115209`.
- Current next action: `none`.
- Status: complete; 4/4 problems and 4/4 checks passed.
