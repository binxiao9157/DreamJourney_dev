...
require(registryTests.contains("self.assertEqual(len(app_routes), 58)"), "Route audit must pin the current route count")
...
require(deployedSmoke.contains("routeCount\") == 58"), "Deployed ownership smoke must pin 58 routes")
