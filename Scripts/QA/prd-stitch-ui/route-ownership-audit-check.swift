...
require(registryTests.contains("self.assertEqual(len(app_routes), 68)"), "Route audit must pin the current route count")
...
require(deployedSmoke.contains("routeCount\") == 68"), "Deployed ownership smoke must pin 68 routes")
require(
