...
require(registryTests.contains("self.assertEqual(len(app_routes), 59)"), "Route audit must pin the current route count")
...
require(deployedSmoke.contains("routeCount\") == 59"), "Deployed ownership smoke must pin 59 routes")
