...
require(registryTests.contains("self.assertEqual(len(app_routes), 60)"), "Route audit must pin the current route count")
...
require(deployedSmoke.contains("routeCount\") == 60"), "Deployed ownership smoke must pin 60 routes")
require(
