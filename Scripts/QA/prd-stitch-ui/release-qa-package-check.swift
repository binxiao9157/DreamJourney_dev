...
let knowledgeReceiptMaintenanceGate = read("Scripts/QA/prd-stitch-ui/run-knowledge-receipt-maintenance-gate.sh")
...
assertContains(releaseRegression, "knowledge-receipt-maintenance-contract-check.swift", "release regression should always run the receipt maintenance static contract")
assertContains(releaseRegression, "RUN_KNOWLEDGE_RECEIPT_MAINTENANCE_GATE", "release regression should expose the optional receipt maintenance full gate")
assertContains(releaseRegression, "run-knowledge-receipt-maintenance-gate.sh", "release regression should call the receipt maintenance full gate")
assertContains(knowledgeReceiptMaintenanceGate, "knowledge-receipt-maintenance-contract-check.swift", "receipt maintenance gate should run the Swift static contract")
assertContains(knowledgeReceiptMaintenanceGate, "run-backend-knowledge-receipt-maintenance-smoke.sh", "receipt maintenance gate should run the backend combined smoke")
...
let requiredScripts = [
    ...
    "Scripts/QA/prd-stitch-ui/public-release-scope-regression-check.swift",
    "Scripts/QA/prd-stitch-ui/public-release-scope-model-smoke.swift",
    "Scripts/QA/prd-stitch-ui/run-public-release-scope-model-smoke.sh",
    ...
    "Scripts/QA/prd-stitch-ui/iphoneos-generic-build-check.swift",
    ...
    "Scripts/QA/prd-stitch-ui/voice-clone-creation-quota-check.swift",
    ...
    "Scripts/QA/prd-stitch-ui/echo-role-voice-profile-selection-check.swift",
    "Scripts/QA/prd-stitch-ui/tencent-voice-clone-echo-contract-check.swift",
    "Scripts/QA/prd-stitch-ui/echo-voice-synthesis-binding-check.swift",
    ...
    "Scripts/QA/prd-stitch-ui/echo-audio-owner-lifecycle-guard-check.swift",
    "Scripts/QA/prd-stitch-ui/echo-digital-human-lifecycle-audio-route-check.swift",
    "Scripts/QA/prd-stitch-ui/echo-digital-human-lifecycle-uiqa-smoke-check.swift",
    "Scripts/QA/prd-stitch-ui/run-echo-digital-human-lifecycle-smoke.sh",
    "Scripts/QA/prd-stitch-ui/echo-audio-owner-coordinator-uiqa-smoke-check.swift",
    "Scripts/QA/prd-stitch-ui/run-echo-audio-owner-coordinator-uiqa-smoke.sh",
    "Scripts/QA/prd-stitch-ui/echo-continuous-turn-uiqa-smoke-check.swift",
    "Scripts/QA/prd-stitch-ui/run-echo-continuous-turn-uiqa-smoke.sh",
    "Scripts/QA/prd-stitch-ui/run-tencent-digital-human-phase1-non-device-gate.sh",
    "Scripts/QA/prd-stitch-ui/digital-human-session-lease-check.swift",
    "Scripts/QA/prd-stitch-ui/run-digital-human-session-lease-gate.sh",
