...
let backendSmokePath = "Scripts/QA/prd-stitch-ui/run-backend-env-smoke.sh"
let archiveSmokePath = "Scripts/QA/prd-stitch-ui/run-archive-to-echo-smoke.sh"
...
assertFileExists(
    "Scripts/QA/prd-stitch-ui/backend-env-smoke-check.swift",
...
for required in [
    ...
    "真机安装/启动已通过",
    "权限与完整语音对话仍待人工验收",
    "paid Apple Developer Team / profile with Push Notifications enabled",
    "verify backend token registration",
    "SpeechEngineToB",
    "DialogEngine",
    "aps-environment",
