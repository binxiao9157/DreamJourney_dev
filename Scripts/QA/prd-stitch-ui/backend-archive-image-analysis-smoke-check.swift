...
let runner = "Scripts/QA/prd-stitch-ui/run-backend-archive-image-analysis-smoke.sh"
let pythonSmoke = "Scripts/QA/prd-stitch-ui/backend-archive-image-analysis-smoke.py"
