...
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/tmp/visual-qa/prd-stitch-ui/knowledge-change-feed-pagination-model-smoke}"
BIN_PATH="$OUTPUT_DIR/knowledge-change-feed-pagination-model-smoke"
