...
require(featureFlags.contains("DJShowDigitalHumanLivePanel"), "QA feature registry should retain the device digital-human launch argument")
require(appDelegate.contains("configuration.shouldEnableDigitalHumanLivePanel"), "AppDelegate should enable the digital human panel through the centralized QA capability")
