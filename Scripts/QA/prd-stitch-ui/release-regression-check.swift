...
assertFileExists("Scripts/QA/prd-stitch-ui/run-release-regression.sh", "release regression runner")
assertFileExists("docs/superpowers/status/2026-06-18-one-command-release-regression.md", "release regression status doc")

let runner = read("Scripts/QA/prd-stitch-ui/run-release-regression.sh")
