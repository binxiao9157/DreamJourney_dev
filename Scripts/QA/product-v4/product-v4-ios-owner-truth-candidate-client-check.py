...
def main() -> None:
    ...
    for test_name in (
        ...
        "func testCandidateReviewUseCaseMapsStructuredKnowledgeCorrectionAndSources()",
        "func testCandidateReviewUseCaseMapsEmotionLabelAsPrimaryField()",
    ...
    for required in (
        ...
        "final class OwnerTruthCandidateDetailViewController",
