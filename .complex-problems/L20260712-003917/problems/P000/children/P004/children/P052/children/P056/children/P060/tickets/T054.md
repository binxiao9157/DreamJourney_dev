...
1. 为 `WP-S0-02` 建立 8 个单结果任务：production fail-closed/readiness、strong challenge/identity binding、session/token family、principal middleware、route policy completeness、resource AuthZ、iOS typed auth cutover、shadow→enforce/legacy retirement。
...
- `WI-S0-02-01..08` 与 `WI-S0-03-01..07` 连续唯一，16字段完整。
